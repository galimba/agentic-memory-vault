...
find "${VAULT_ROOT}" -name "*.md" -type f -exec sed -i \
...
echo "  3. Add company context to docs/company-context.md"
echo "  4. Drop your first source document into raw/"
echo "  5. Tell your agent: 'Ingest the new file in raw/'"
echo ""
echo "Run diagnostics: .vault/scripts/vault-tools.sh doctor"
echo ""
