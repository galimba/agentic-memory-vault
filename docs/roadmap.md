...
| Decay scoring for freshness | [#8](https://github.com/galimba/agentic-memory-vault/issues/8) | Closed — documented as adopter customization, see [freshness-customization.md](freshness-customization.md) | `discussion` |
...
| Lifecycle tier tags | [#12](https://github.com/galimba/agentic-memory-vault/issues/12) | Closed — documented as adopter customization, see [freshness-customization.md](freshness-customization.md) | `discussion` |
